...
TOKEN = "8056137260:AAH6R-9ZI9CFIp7qP064anU3VV_2yUwFDv4"
...
def send_welcome(message):
    users = load_users()
    if str(message.from_user.id) in users or message.from_user.id == 7792168914: #ايديك
    ...
    else:bot.send_message(message.chat.id, "يامزعج!")
...
def handle_id(message):
    if message.from_user.id == 7792168914: #ايديك
